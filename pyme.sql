...
--
-- Servidor: localhost
-- Tiempo de generación: 30-12-2019 a las 08:07:43
...
INSERT INTO `hoja_de_tiempo` (`id`, `usuario`, `fecha_creacion`, `fecha_finalizacion`, `estado`, `comentarios`) VALUES
(1, 116050640, '2019-12-27 00:00:00', NULL, 1, NULL);
...
INSERT INTO `proyecto` (`id`, `nombre`, `descripcion`, `departamento`, `administrador`) VALUES
(1, 'proyecto1', 'pruebaprueba', 1, 111111111),
(2, 'proyecto2', 'pruebaa', 3, 116050640),
(3, 'proyecto3', 'pruebaUpload', 3, 116050640);
...
INSERT INTO `tarea` (`id`, `nombre`, `descripcion`, `fecha_limite`, `proyecto`, `hoja_tiempo`, `estado`, `lunes`, `martes`, `miercoles`, `jueves`, `viernes`) VALUES
(1, 'tarea1', 'blah blah blah', '2019-12-31', 2, 1, 0, NULL, NULL, NULL, NULL, NULL),
(2, 'tarea2', 'bleh bleh bleh', '2019-12-30', 2, 1, 0, NULL, NULL, NULL, NULL, NULL);
...
(116050640, 'Manuel', 'Ruiz', 'Androvetto', 'mra@example.com', 'mra', '88338833', 3, 1),
